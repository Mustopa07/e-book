...
<section class="bg-blueGray-50">
  <div class="w-full lg:w-4/12 px-4 mx-auto pt-28">
    <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-md shadow-gray-500 rounded-lg bg-blueGray-200 border-0 pt-8">
      <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
        ...
        <form>
          ...
          <div class="text-center mt-10">
            <button class="mb-3 bg-gray-800 text-white active:bg-blueGray-600 text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 w-full ease-linear transition-all duration-150" type="button"> Login </button>
            <small class="pt-5">Don't Have An Account?, <a href="{{ route('regist') }}" class="text-blue-400">Register Here</a></small>
          </div>
        </form>
      </div>
    </div>
